...
# user = User.create(name: 'Azaria', phone_number: '0987654328', email: 'allysaidi64@gmail.com', password: '1234567890YT')
# Reservation.create(user: user, doctor: d1, reservation_time: DateTime.new)
# Reservation.create(user: user, doctor: d2, reservation_time: DateTime.new)
# Reservation.create(user: user, doctor: d4, reservation_time: DateTime.new)